...
function getQuestion(num) {
    const questions = [
        "Które z podanych czynników wpływających na środowisko powinny być poddane państwowej regulacji? (Możesz wybrać wiele odpowiedzi)",
        "Którą z podanych form państwowych uważasz za najodpowiedniejszą?",
        "Jaki z podanych systemów sprawowania władzy popierasz?",
        "Jakie wymagania powinna spełniać osoba chcąca głosować w wyborach? (Możesz wybrać wiele odpowiedzi)",
        "Czy popierasz obowiązkową służbę wojskową?",
        "Który z podanych typów polityki zagranicznej popierasz (uwzględniając użycie armii)?",
    ...
    return (<Typography variant="h6" align="center" gutterBottom>{questions[num]}</Typography>);
}
